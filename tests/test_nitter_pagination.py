...
class NitterPlainTextFilterTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_skip_plain_text_keeps_video_thumbnail_tweets(self):
        client = NitterClient(
            {"instances": ["https://nitter.example"], "request_timeout": 12}
        )
            ...
            return _rss_with_descriptions(
                [
                    (
                        "/nasa/status/100",
                        "Video",
                        '<a href="https://nitter.example/nasa/status/100#m">'
                        "<br>Video<br>"
                        '<img src="https://nitter.example/pic/'
                        'amplify_video_thumb%2F2042858549571915776%2Fimg%2Fv.jpg" />'
                        "</a>",
                    ),
                    (
                        "/nasa/status/101",
                        "Video",
                        '<img src="https://nitter.example/pic/'
                        'ext_tw_video_thumb%2F1844320908279681041%2Fpu%2Fimg%2Fq.jpg" />',
                    ),
                    (
                        "/nasa/status/102",
                        "Video",
                        '<img src="https://nitter.example/pic/'
                        'future_video_thumb%2F1844320908279681041%2Fpu%2Fimg%2Fq.jpg" />',
                    ),
                    ("/nasa/status/103", "t4", "纯文本无图"),
                ]
            )
    ...
    async def test_skip_plain_text_filters_quote_media_only(self):
        client = NitterClient(
            {"instances": ["https://nitter.example"], "request_timeout": 12}
        )
            ...
            return _rss_with_descriptions(
                [
                    (
                        ...
                        "t1",
                        "主推文本"
                        '<div class="tweet-body" class="quote">'
                        '<img src="https://nitter.net/pic/media%2Fquoted.jpg" />'
                        "</div>",
                    ),
                    (
    ...
    async def test_skip_plain_text_keeps_own_media_before_quote(self):
        client = NitterClient(
            {"instances": ["https://nitter.example"], "request_timeout": 12}
        )
    ...
    async def test_skip_plain_text_keeps_own_media_after_quote_img(self):
        client = NitterClient(
            {"instances": ["https://nitter.example"], "request_timeout": 12}
        )
    ...
    async def test_skip_plain_text_ignores_extra_img_endtag_inside_quote(self):
        client = NitterClient(
            {"instances": ["https://nitter.example"], "request_timeout": 12}
        )
            ...
            return _rss_with_descriptions(
                [
                    (
                        ...
                        "主推文本"
                        '<div class="quote">'
                        '<img src="https://nitter.net/pic/media%2Fquoted1.jpg">'
                        "</img>"
                        '<img src="https://nitter.net/pic/media%2Fquoted2.jpg">'
                        "</div>",
                    ),
                ]
            )
    ...
    async def test_skip_plain_text_stats_excludes_text_reposts(self):
        client = NitterClient(
            {"instances": ["https://nitter.example"], "request_timeout": 12}
        )
        ...
        def body(request):
            ...
            return _rss_with_descriptions(
                [
                    ("/BBCWorld/status/100", "repost", "转发纯文本"),
                    ("/nasa/status/101", "t2", "本账号纯文本"),
                    (
                        "/nasa/status/102",
                        "t3",
                        '<img src="https://nitter.net/pic/media%2Fabcd.jpg" />',
