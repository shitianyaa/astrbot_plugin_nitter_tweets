...
- WebUI 面板大修：删除约 1400 行死 CSS（"Premium Design Concept" 遗留层），style.css 从 2942 行精简到 1542 行；合并「系统维护清理」tab 到「控制台总览」底部 danger zone（5 tab → 4 tab，后新增「插件配置」tab 共 5 tab）；总览新增已配置实例列表展示。
